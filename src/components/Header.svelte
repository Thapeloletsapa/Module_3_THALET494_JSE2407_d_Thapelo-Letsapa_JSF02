<script>
    ...
    <header class="sticky z-50 top-0">
        ...
        <div bind:this={navbarDropdown} class="hidden w-full md:block md:w-auto" id="navbar-dropdown">
    ...
    <a href="Cart" class="lg:hidden md:hidden py-2 px-3 text-white rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0">Cart</a>
